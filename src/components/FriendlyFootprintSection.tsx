...
export default function FriendlyFootprintSection() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      scrollTl
        // Phase 1: Fade out top header and bullet points (Progress 0 to 0.5)
        .to(
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex min-h-[100dvh] w-full flex-col justify-between gap-12 px-6 pt-16 pb-16 md:px-16 lg:pt-20 lg:pb-20">
          ...
          <div ref={topContentRef} className="flex flex-col items-start gap-3 w-full">
            <h2 className="big-heading text-brand-dark select-none w-full max-w-[1300px]">
              Friendly Footprint Initiatives
            </h2>
            <span className="sub-heading text-brand-grey select-none uppercase tracking-wide">
              Sustainability & Community
            </span>
          </div>

          {/* Bottom Row: Image placeholder (left) & Details (right) */}
          <div className="mx-auto w-full flex flex-col lg:flex-row items-center justify-start gap-8 lg:gap-12 mt-8 lg:mt-0">
            {/* Left Column: Image slot with aspect-ratio preservation */}
            ...
            <div ref={detailsRef} className="flex-1 flex flex-col justify-center items-start pl-0 lg:pl-4">
              <ul className="flex flex-col gap-6 select-none max-w-none w-full">
                <li className="sustainability-bullet text-brand-dark flex items-start gap-4">
                  <span className="text-brand-grey shrink-0 mt-1 md:mt-2">•</span>
                  <span>100% solar-powered plant of 700 kW</span>
                </li>
                <li className="sustainability-bullet text-brand-dark flex items-start gap-4">
                  <span className="text-brand-grey shrink-0 mt-1 md:mt-2">•</span>
                  <span>Kerala State Renewable Energy Award recipient</span>
                </li>
                <li className="sustainability-bullet text-brand-dark flex items-start gap-4">
                  <span className="text-brand-grey shrink-0 mt-1 md:mt-2">•</span>
                  <span>10 acres ear-marked as a native-planted greenbelt</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        >
          <img
            ref={imageRef}
            src="/images/about/wilton-friendly-footprint-initiatives.jpg"
            alt="Friendly Footprint Initiatives"
